  ...
  render () {
    return html`
      <div class="minecraft">
        ...
        <span class="splash">Ash Client Finally Ran On Web</span>
      </div>
      ...
      <div class="menu">
        ...
        <div class="menu-row">
          <pmui-button pmui-width="98px" pmui-label="Github" @pmui-click=${() => openURL('https://github.com/Ashendulmina')}></pmui-button>
          <pmui-button pmui-width="98px" pmui-label="Discord" @pmui-click=${() => openURL('https://github.com/Ashendulmina')}></pmui-button>
        </div>
      </div>

      <div class="bottom-info">
        <span>Ash Client Web v9.3</span>
